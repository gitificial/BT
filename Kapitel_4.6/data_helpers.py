...
#-------------------- Generate TRAIN subst --------------------------------------
    positive_examples_lowerhalf = list(open("./data/positive_half_shuffled_substitute.txt").readlines())
    positive_examples_lowerhalf = [s.strip() for s in positive_examples_lowerhalf]

    negative_examples_lowerhalf = list(open("./data/negative_half_shuffled_substitute.txt").readlines())
